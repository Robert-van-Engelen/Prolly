...
MEM_DISP_LINE_0 = 0xfd80
MEM_DISP_LINE_1 = 0xfd98
MEM_DISP_LINE_2 = 0xfdb0
MEM_DISP_LINE_3 = 0xfdc8
...
BASIC_START_L = 0xffd7                  ; pointer to basic start low byte
BASIC_START_H = 0xffd8                  ; pointer to basic start high byte
BASIC_END_L   = 0xffd9                  ; pointer to basic end low byte
BASIC_END_H   = 0xffda                  ; pointer to basic end high byte
BASIC_MERGE_L = 0xffdb                  ; pointer to basic merge low byte
BASIC_MERGE_H = 0xffdc                  ; pointer to basic merge high byte
BASIC_VARS_L  = 0xffdd                  ; pointer to basic variables low byte
BASIC_VARS_H  = 0xffde                  ; pointer to basic variables high byte

; BASIC state flags

BASIC_FLAGS   = 0xffe8                  ; 0x80 MERGE flag
BASIC_EXEC_L  = 0xfef0                  ; pointer to basic program being executed
BASIC_EXEC_H  = 0xfef1                  ; pointer to basic program being executed high byte
...
BASIC_LAST_L  = 0xfef2                  ; pointer to the last point in BASIC (cursor)
BASIC_LAST_H  = 0xfef3
BASIC_BREAK_L = 0xfef4                  ; pointer to the break point in BASIC
BASIC_BREAK_H = 0xfef5
BASIC_ERROR_L = 0xfef6                  ; pointer to the error point in BASIC
BASIC_ERROR_H = 0xfef7

; Memory location

BASVAR_STR_ESC = 0xF5;   245            ; Excape character to indicate a
                                        ; string variable
MEM_BASVAR_Z  = 0xf9d0;  63952          ; Basic std var Z
...
MEM_INPUT_BUF = 0xfd20;  28336          ; The input buffer 80 byte
;MEM_BAS_WAIT  = 0x70B3;  28851          ; Duration of WAIT interval

MEM_LCD_L1C1  = 0x2800;	 10240		; Screen organization RAM
...
; Flags for status sysbols on LCD
...
MEM_LCD_BASE  = 0x2800;  Display memory base address
...
; We have a RAM card, all cards are mirrored at 0x8000 to 0xffff
RAM_START = 0x8000

RAM_CARD_START_L  = 0xfff6
RAM_CARD_START_H  = 0xfff7
RAM_CARD_END_L    = 0xfff8
RAM_CARD_END_H    = 0xfff9
